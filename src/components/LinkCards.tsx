...
const LinkCards = () => {
  return (
    <div className={styles.container}>
      {/* Card 1: Github */}
      <a href="#" data-text="Github" style={{ '--r': -15 } as React.CSSProperties} className={styles.outerCard} aria-label="Github">
      ...
      {/* Card 2: Code */}
      <a href="#" data-text="Code" style={{ '--r': 5 } as React.CSSProperties} className={styles.outerCard} aria-label="Code">
        <div className={styles.dot} />
        <div className={styles.innerCard}>
          <div className={styles.ray} />
      ...
      {/* Card 3: Earn */}
      <a href="#" data-text="Earn" style={{ '--r': 25 } as React.CSSProperties} className={styles.outerCard} aria-label="Earn">
        <div className={styles.dot} />
        <div className={styles.innerCard}>
          <div className={styles.ray} />
