...
const TechPhysicsSandbox = dynamic(() => import("@/components/TechPhysicsSandbox"), { ssr: false });
const HardwareShowroom = dynamic(() => import("@/components/HardwareShowroom"), { ssr: false });
