...
const FallingMatrix = dynamic(() => import("@/components/FallingMatrix"), { ssr: false });
...
const AngledGallery = dynamic(() => import("@/components/AngledGallery"), { ssr: false });
      ...
      <div className="relative z-10 pt-12 pb-4">
        ...
        <section id="blog" className="scroll-mt-24 mt-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <a href="#" className="block rounded-2xl glass p-6 border border-white/10 bg-gradient-to-br from-white/5 to-transparent shadow-xl hover:border-neon-cyan transition-colors group">
              <div className="sm:flex sm:justify-between sm:gap-4 lg:gap-6">
                <div className="sm:order-last sm:shrink-0">
                  <Image alt="Blog" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?auto=format&fit=crop&q=80&w=1160" width={72} height={72} className="size-16 rounded-full object-cover sm:size-18" />
                </div>
            ...
            <a href="#" className="block rounded-2xl glass p-6 border border-white/10 bg-gradient-to-br from-white/5 to-transparent shadow-xl hover:border-electric-purple transition-colors group">
              <div className="sm:flex sm:justify-between sm:gap-4 lg:gap-6">
                <div className="sm:order-last sm:shrink-0">
                  <Image alt="Blog" src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=1160" width={72} height={72} className="size-16 rounded-full object-cover sm:size-18" />
                </div>
        ...
        <section id="contact" className="scroll-mt-24 overflow-hidden glass rounded-3xl sm:grid sm:grid-cols-2 sm:items-center mt-32 border border-white/10 bg-gradient-to-br from-white/5 to-transparent shadow-xl">
          ...
          <div className="h-full w-full relative sm:h-[calc(100%-2rem)] sm:self-end">
            ...
            <Image fill alt="Cyber Luxury" src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=1160" className="object-cover opacity-40 sm:rounded-ss-[30px] md:rounded-ss-[60px]" sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
        </section>
