      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-36">
        ...
        <header className="mb-24 text-center max-w-3xl mx-auto space-y-6">
          ...
          <m.p
            ...
            className="text-zinc-200 text-base sm:text-lg font-normal leading-relaxed"
          >
          ...
          {mappedProjects.map((project, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`lg:col-span-5 space-y-8 flex flex-col justify-center ${isEven ? "lg:order-1" : "lg:order-2"
                    }`}
                >
                  ...
                  {/* Description */}
                  <p className="text-zinc-200 text-base md:text-lg font-normal leading-relaxed">
                    {project.description}
                  </p>
                  ...
                  <div className="relative overflow-hidden p-5 rounded-2xl border border-white/5 bg-gradient-to-r from-white/[0.02] to-transparent flex items-center gap-4 shadow-[0_0_30px_rgba(0,0,0,0.4)]">
                    ...
                    <div>
                      <h4 className="text-[12px] font-satoshi text-zinc-100 uppercase tracking-wider font-extrabold mb-0.5 opacity-90">Value Realization</h4>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {project.metrics.map((metric: any) => (
                      ...
                      >
                        ...
                        <span className="block text-[12px] font-satoshi text-zinc-100 uppercase tracking-wider font-extrabold mt-2 leading-none opacity-90">
                          {metric.label}
                        </span>
                      </div>
                    ))}
        ...
        <section className="mt-48 border-t border-white/5 pt-32 space-y-16">
          <header className="space-y-3">
            ...
            <p className="text-zinc-300 font-satoshi text-base font-medium max-w-xl">
          ...
          <div className="relative flex flex-col border-t border-white/5">
            {miniProjects.map((item, idx) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r from-white/[0.025] to-transparent z-0 transition-opacity duration-500 pointer-events-none ${hoveredRow === idx ? "opacity-100" : "opacity-0"
                    }`}
                />
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 relative z-10 flex-1">
                  <span className="text-zinc-400 font-mono text-sm tracking-widest font-extrabold w-12 sm:w-16">
                    {item.year}
                  </span>
                  <div className="space-y-1 flex-1 max-w-lg">
                    ...
                    <p className="text-zinc-300 font-satoshi text-xs font-normal leading-relaxed">
                      {item.desc}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between mt-4 md:mt-0 relative z-10 md:w-[350px] justify-end gap-12">
                  ...
                  <div className="flex gap-1.5 max-sm:hidden">
                    {item.tech.map((t) => (
                      <span key={t} className="text-[10px] font-mono px-2 py-0.5 bg-white/5 border border-white/5 text-zinc-400 rounded">
                        {t}
                      </span>
                    ))}
                  </div>

                  <span className="text-zinc-400 group-hover:text-zinc-200 text-xs font-mono font-bold tracking-widest uppercase text-left md:text-right md:w-36">
                    {item.category}
                  </span>
        ...
        <section className="mt-48 mb-24 w-full relative z-20">
          <div className="w-full rounded-[2.5rem] glass bg-cyber-black/60 p-10 md:p-16 relative overflow-hidden shadow-2xl">
            ...
            <div className="max-w-3xl mx-auto text-center space-y-8 relative z-10 flex flex-col items-center">
              ...
              <p className="text-zinc-200 font-satoshi text-base md:text-lg font-normal max-w-xl">
