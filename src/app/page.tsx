        ...
        <section className="mb-0 overflow-hidden py-32 relative">
          ...
          <div className="transform -rotate-6 scale-125 space-y-6">
            ...
            <div className="flex overflow-hidden select-none gap-8">
              <div className="flex flex-shrink-0 justify-around min-w-full gap-8 animate-marquee hover:[animation-play-state:paused] [--duration:25s]">
            ...
            {/* Row 2 */}
            <div className="flex overflow-hidden select-none gap-8">
              <div className="flex flex-shrink-0 justify-around min-w-full gap-8 animate-marquee-reverse hover:[animation-play-state:paused] [--duration:30s]">
