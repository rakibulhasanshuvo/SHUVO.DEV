    ...
    <div className="relative min-h-screen bg-transparent text-white font-satoshi">
      ...
      <div className="relative z-10 pt-12 pb-4">
        ...
        <div className="relative w-full">
          <section className="relative mb-20 md:mb-36 pt-10 max-w-[1440px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <section id="work" className="scroll-mt-24 mb-20 md:mb-36">
          <StickyStackCards isMobileServer={isMobile} />
        </section>

        {/* Technical Marquee */}
        <div className="relative w-full overflow-hidden mb-20 md:mb-36">
        ...
        <section id="process" className="scroll-mt-24 mb-20 md:mb-36 w-full relative">
        ...
        {/* Pricing options */}
        <section className="scroll-mt-24 mb-20 md:mb-36 max-w-[1440px] mx-auto px-6">
        ...
        {/* FAQs */}
        <section id="faq" className="scroll-mt-24 mb-20 md:mb-36 relative overflow-hidden">
          {!isMobile && (
        ...
        {/* Blog section */}
        <section id="blog" className="scroll-mt-24 mb-20 md:mb-36">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-text-muted">
                <li><Link href="/projects" className="block py-2 hover:text-neon-cyan transition-colors focus-visible:text-neon-cyan focus:outline-none rounded">Work</Link></li>
                <li><Link href="/about" className="block py-2 hover:text-neon-cyan transition-colors focus-visible:text-neon-cyan focus:outline-none rounded">About</Link></li>
                <li><Link href="/#process" className="block py-2 hover:text-neon-cyan transition-colors focus-visible:text-neon-cyan focus:outline-none rounded">Process</Link></li>
                <li><Link href="/#reviews" className="block py-2 hover:text-neon-cyan transition-colors focus-visible:text-neon-cyan focus:outline-none rounded">Reviews</Link></li>
                <li><Link href="/contact" className="block py-2 hover:text-neon-cyan transition-colors focus-visible:text-neon-cyan focus:outline-none rounded">Contact</Link></li>
              </ul>
            </div>
